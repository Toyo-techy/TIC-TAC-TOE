...
int main()
{
	...
	{
	" _______ _____ _____   _______ ___   _____   _______ ____  ______ ",
	"|__   __|_   _/ ____| |__   __/ _ \\ / ____| |__   __/ __ \\|  ____|",
	"   | |    | || |         | | | | | | |         | | | |  | | |__   ",
	"   | |    | || |         | | | | | | |         | | | |  | |  __|  ",
...
void getUserInput(bool xTurn, string gameBoard[ROWS][COLS])
{
	...
	//by the time it gets here, we know its a VALID row and col,
...
string getWinner(string gameBoard[ROWS][COLS])
{
	...
	//check diagonals
	//there are two diagonals, we can test manually / no-loop

	//upper-left to the bottom right diagonal
